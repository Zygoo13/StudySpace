-- ================================================
-- RESET FOREIGN KEY + CLEAR DATA (Railway compatible)
-- ================================================
...
-- Reset AUTO_INCREMENT (optional nhưng đẹp)
...
ALTER TABLE service_inventory AUTO_INCREMENT = 1;
ALTER TABLE reservation AUTO_INCREMENT = 1;
ALTER TABLE reservation_desk AUTO_INCREMENT = 1;
ALTER TABLE reservation_service AUTO_INCREMENT = 1;
...
-- ================================================
-- INSERT RESERVATION-DESK (ManyToMany)
-- ================================================
...
-- ================================================
-- INSERT RESERVATION-SERVICE (ManyToMany)
-- ================================================
